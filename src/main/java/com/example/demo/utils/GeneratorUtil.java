...
public class GeneratorUtil {
    ...
    private static final String URL = "jdbc:mysql://47.111.163.12:3306/a_task?useUnicode=true&characterEncoding=utf-8&useSSL=false";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "Wojiaolzj123@";
...
//                .setCfg(injectionConfig)
    ...
    private static GlobalConfig getGlobalConfig() {
        ...
        String authorName = "lizhijiang";
        globalConfig.setOpen(false)
                //new File(module).getAbsolutePath()得到模块根目录路径，因事Maven项目，代码指定路径自定义调整
                .setOutputDir(new File("src").getAbsolutePath()+"/main/java")
                //生成文件的输出目录
